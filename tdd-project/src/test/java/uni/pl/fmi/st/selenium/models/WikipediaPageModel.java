...
public class WikipediaPageModel {
	...
	WebElement zaWikipedia;
	/**
	 * Constructor
	 * Initialize instance of Wikipedia Page object Model
	 * 
	 * @param driver
	 */
	...
	public WebElement getEnglishLanguage() {
		return driver.findElement(By.linkText("English"));
		
	}
	public WebElement getSecondHeaderElement() {
		return driver.findElement(By.id("p-lang-label"));
